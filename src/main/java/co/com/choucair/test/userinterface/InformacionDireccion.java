...
public class InformacionDireccion {
    ...
    public  static final  Target BOTOB_CONTINUAR_DISPOSITIVOS = Target.the("Dispositivos").located(By.cssSelector("#regs_container > div > div:nth-child(2) > div > div.ui-view > div > form > div:nth-child(2) > div > a > span"));
