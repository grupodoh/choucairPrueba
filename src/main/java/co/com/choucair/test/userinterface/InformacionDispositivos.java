...
public class InformacionDispositivos {
    ...
    public static final Target VERSION_SO_CONT = Target.the("Version del sistema operativo").located(By.xpath("/html/body/ui-view/main/section/div/div[2]/div/div[2]/div/div[1]/div[3]/div[1]/div[2]/div[2]/div/div[1]/span/span[1]"));
